...
//  2. Alternatively, you can draw the QR code on a Canvas Texture:
//     First, you must define your texture in ANIMDEFS,
//     then you can pass the name of the texture to the DrawCanvasTexture function:
//      ...
